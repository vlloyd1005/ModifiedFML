#ifndef COSMOLOGY_W0WA_DETG_HEADER
#define COSMOLOGY_W0WA_DETG_HEADER
...
class Cosmologyw0waCDM_DETG final : public Cosmology {
  public:
    Cosmologyw0waCDM_DETG() { name = "w0waCDM_DETG"; }
    ...
    void read_parameters(ParameterMap & param) override {
        ...
        // Vic start changes
        beta = param.get<double>("cosmology_beta");
        p = param.get<double>("cosmology_p");
        // Vic end changes
    }
    ...
    double get_p() const override { return p; }
    // Vic changes end
  ...
  protected:
    //========================================================================
    // Parameters specific to the w0waCDM+beta model
    //========================================================================
    double w0;
    double wa;
    // Vic start changes
